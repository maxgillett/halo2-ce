//! This module exercises the `ff_derive` procedural macros, to ensure that
//! changes to the `ff` crate are reflected in `ff_derive`. It also uses the
//! resulting field to test some of the APIs provided by `ff`, such as batch
//! inversion.
