...
fn prime_field_constants_and_sqrt(
    ...
    // i.e., if our modulus is 381 bits and our representation is 384 bits, we
    // should shave 3 bits from the beginning of a randomly sampled 384 bit
    // representation to reduce the cost of rejection sampling.
...
fn prime_field_impl(
    ...
    /// Generates an implementation of multiplicative inversion within the
    /// target prime field.
    fn inv_impl(
        a: proc_macro2::TokenStream,
        name: &syn::Ident,
