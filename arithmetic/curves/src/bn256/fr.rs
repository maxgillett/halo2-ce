...
use ff::PrimeField;
use pasta_curves::arithmetic::{Extendable, FieldExt, FieldExtension, Group, SqrtRatio};
use rand::RngCore;
...
///
/// is the scalar field of the bn256 curve.
...
/// A field can be extended to itself
impl Extendable<1> for Fr {
    type BaseField = Self;
    type Extension = Self;
}

impl FieldExtension<1> for Fr {
    type BaseField = Fr;
